...
public class Repository {
	...
	public void insert(Owner ownerFormulario) {
		...
		try {
			preparedStatement = conn.prepareStatement("INSERT INTO OWNER (nombreDueño,DNI)" +
					"VALUES (?, ?)");
			preparedStatement.setString(1, ownerFormulario.getName());
			preparedStatement.setString(2, ownerFormulario.getDNI());
	...
	public void update(Owner ownerFormulario) {
		...
		try {
			preparedStatement = conn
					.prepareStatement("UPDATE OWNER SET nombreDueño = ?,DNI = ? WHERE codOwner = ?");
			preparedStatement.setString(1, ownerFormulario.getName());
			preparedStatement.setString(2, ownerFormulario.getDNI());
